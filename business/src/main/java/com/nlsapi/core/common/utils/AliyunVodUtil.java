...
import com.nlsapi.core.business.enums.exception.FileTransExceptionEnum;
...
/**
 * vod管理控制台
 * https://vod.console.aliyun.com/?spm=5176.8413026.J_3895079540.1.1b591029D5qTKy#/media/video/list
 * 智能语音识别控制台
 * https://nls-portal.console.aliyun.com/applist
 * aliyun上传SDK包下载
 * https://help.aliyun.com/zh/vod/developer-reference/sdk-overview-and-download?spm=a2c4g.11186623.0.i6#section-dd8-5u2-5b9
 */
@Component
public class AliyunVodUtil {
    ...
    @Value("${vod.aliyun.accessKeyId}")
    public void setAccessKeyId(String accessKeyId) {
        AliyunVodUtil.accessKeyId = accessKeyId;
    }

    @Value("${vod.aliyun.accessKeySecret}")
    public void setAccessKeySecret(String accessKeySecret) {
        AliyunVodUtil.accessKeySecret = accessKeySecret;
    }
    ...
    public void setFileTransAudioPrice(BigDecimal fileTransAudioPrice) {
        AliyunVodUtil.fileTransAudioPrice = fileTransAudioPrice;
    }
    ...
    public static OSSClient initOssClient(JSONObject uploadAuth, JSONObject uploadAddress) {
        String endpoint = uploadAddress.getStr("Endpoint");
        String accessKeyId = uploadAuth.getStr("AccessKeyId");
        String accessKeySecret = uploadAuth.getStr("AccessKeySecret");
        String securityToken = uploadAuth.getStr("SecurityToken");
...
//            throw new BusinessException(BusinessExceptionEnum.GEN_SUBTITLE_ERROR);
     ...
     * 计算音频转字幕应收金额
     */
    public static BigDecimal calcAmount(String videoId) {
        try {
...
//            log.info("视频：{}，时长：{}，单价：{}", videoId, duration, filetransAudioPrice);
            ...
            LogUtil.error("计算音频转字幕应收金额异常", e);
            throw new BusinessException(FileTransExceptionEnum.CALC_AMOUNT_FAILED);
        }
    }
